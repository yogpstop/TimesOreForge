...
public class GuiSlotOres extends GuiSlot {
	...
	public GuiSlotOres(Minecraft par1Minecraft, int par2, int par3, int par4,
			int par5, int par6, GuiSetting parents) {
	...
	protected void drawSlot(int var1, int var2, int var3, int var4,
		...
		Minecraft.getMinecraft().fontRenderer
				.drawStringWithShadow(
						name,
						(this.parent.width * 3 / 5 - Minecraft.getMinecraft().fontRenderer
